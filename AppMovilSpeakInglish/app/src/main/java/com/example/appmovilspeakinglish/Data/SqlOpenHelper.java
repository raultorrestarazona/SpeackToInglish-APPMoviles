...
public class SqlOpenHelper extends SQLiteOpenHelper {
    public SqlOpenHelper(Context contexto){
        super(contexto,"SpeakToInglish.db",null,5);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into tb_diccionario values(null,'buenas noches','good night')");
        db.execSQL("insert into tb_diccionario values(null,'buenos dias','good morning')");
        db.execSQL("insert into tb_diccionario values(null,'chau','bye')");
        db.execSQL("insert into tb_diccionario values(null,'eat','comer')");
        db.execSQL("insert into tb_diccionario values(null,'sleep','dormir')");
